...
function ContactForm({ className }: { className?: string }) {
	...
	return (
		...
		>
			...
			/>
			<Button
				className="text-base font-heading max-sm:text-2xl min-w-min sm:self-start text-theme-white bg-theme-accent rounded-md shadow-2xl shadow-black px-10 text-[clamp(0.925rem,-0.875rem+3vw,1.75rem)]"
				type="submit"
			>
				Send
			</Button>
