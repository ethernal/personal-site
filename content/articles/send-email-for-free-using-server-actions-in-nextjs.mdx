...
As always you can contact me ([via the form](/contact) for example 😄) and let me know what you think. Any feedback is welcome and I will use it to improve the article.
