...
Server actions are [stable since Next.js 14](https://nextjs.org/blog/next-14#server-actions-stable) and today I'll show you how I am using them to send emails using nodemailer on this website without the need for additional services (apart from free email account).
...
<p className="text-4xl text-red-600">//TODO: explain how to use it</p>
